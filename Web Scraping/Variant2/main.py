...
def gouache():
    ...
    start1 = time.time() #start the first time controller
    
    #Parsing main SERP at artsklad.ua
    ...
    #Parsing main SERP at masterkisti.com.ua
    ...
    #Parsing main SERP at kancmart.com.ua
    ...
    #Parsing main SERP at office-prestige.com.ua        
    ...
    #end of the first time controller
    end1 = time.time()
    print(f'Data from all main SERPs has been parsed in {(end1-start1):.03f} sec')
    
    start2 = time.time() #start the second time controller
    
    #parse all additional pages from each website using multiprocessing
    with Pool(100) as p:
    ...
    #end of the second time controller
    end2 = time.time()
    ...
    end3 = time.time()
    print(f'Final dataframe has been formed and processed in {(end3-start3):.03f} sec')

#four auxiliary functions for parsing inside pages of each website 
