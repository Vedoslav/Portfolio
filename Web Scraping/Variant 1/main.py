...
def gouache():
    ...
    #In this variant the main function is divided in 5 blocks, each of them has its own time controller. While parsing additional pages of each website multiprocessing is used. 
    
    #Parsing main SERP at artsklad.ua and additional pages with the sub-function
    start1 = time.time()
    ...
    #Parsing main SERP at masterkisti.com.ua and additional pages with the sub-function
    start2 = time.time()
    ...
    #Parsing main SERP at kancmart.com.ua and additional pages with the sub-function
    start3 = time.time()
    ...
    #Parsing main SERP at office-prestige.com.ua and additional pages with the sub-function
    start4 = time.time()
